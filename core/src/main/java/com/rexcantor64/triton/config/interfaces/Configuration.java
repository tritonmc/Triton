...
public final class Configuration {
    ...
    Configuration(Map<?, ?> map, Configuration defaults) {
        ...
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            ...
            if (entry.getValue() instanceof Map) {
                this.self.put(key, new Configuration((Map) entry.getValue(), (defaults == null) ? null : defaults
                        .getSection(key)));
            } else {
    ...
    public Configuration getSection(String path) {
        ...
        return (Configuration) get(path, (def instanceof Configuration) ? def : new Configuration((defaults == null)
                ? null : defaults
                .getSection(path)));
    }
