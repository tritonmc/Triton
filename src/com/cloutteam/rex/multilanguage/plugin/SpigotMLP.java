...
public class SpigotMLP extends JavaPlugin implements MLPInterface {
	 ...
	 * @author Rexcantor64
	 * 
	 * @deprecated Use {@link MultiLanguagePlugin#get() get()} on the
	 *             {@link MultiLanguagePlugin MultiLanguagePlugin class} instead
	 *             and cast it to {@link SpigotMLP SpigotMLP}. This method will
	 *             be removed on the next versions.
	 */
	@Deprecated
