...
public interface MessageParser {
    ...
    /**
     * Find and replace Triton placeholders in a String.
     * <p>
     * A translation can yield three states:
     * <ul>
     *     <li>placeholders are found and therefore translated;</li>
     *     <li>placeholders aren't found and therefore the text is left unchanged;</li>
     *     <li>a "disabled line" placeholder is found.</li>
     * </ul>
     * See {@link TranslationResult} for more details.
     *
     * @param text     The text to find and replace Triton placeholders on.
