...
[Download API for Triton 1.3.0](https://cdn.rexcantor64.com/triton/api/TritonAPI-v1.3.0.jar) or [add it to your project using Gradle/Maven](https://jitpack.io/#diogotcorreia/Triton).
