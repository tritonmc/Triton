...
[Download API for Triton 2.1.1](https://cdn.rexcantor64.com/triton/api/TritonAPI-v2.0.0.jar) or [add it to your project using Gradle/Maven](https://jitpack.io/#diogotcorreia/Triton).
